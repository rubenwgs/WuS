...
**Definition:** Sei $X$ eine diskrete Zufallsvaraible mit Gewichtsfunktion $p_X$. Dann definieren wir den *Erwartungswert* von $X$ als
...
Wir codieren also die Folge der Ergebnisse als binäre Folge, indem wir $1$ für Erfolg und $0$ für Misserfolg schreiben. Unter den Annahmen $(1)$ und $(2)$ bilden die Zufallsvaraiblen $Y_i$ eine *Folge unabhängiger 0-1-Experimente* mit Erfolgsparameter $p$.
...
Desweiteren gilt für eine Bernoulli-Verteilung:
